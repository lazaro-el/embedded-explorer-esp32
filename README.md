...
This is the preferred and easiest way to start coding. It also allows you to build and test code for real hardware.
...
If you cannot configure your system properly, you can use Wokwi for programming, building and simulation.

- Go to the website www.wokwi.com  
- Choose ESP32 then ESP-IDF Templates then ESP32  
- Copy the content from explorer_main.c into main.c  
- Copy the content of diagram.json from git into the web editor  
